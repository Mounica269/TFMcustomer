...
const MyPhotos = (props) => {
    ...
    const CustomToggle = React.forwardRef(({ children, onClick }, ref) => (
        <span style={{ cursor: "pointer", fontSize: "16px" }} ref={ref} onClick={onClick}>
            {children}
            <i className="bi bi-chevron-down text-dark mx-1"></i>
        </span>
    ));
    ...
    <div className="db-inte-main">
        <ul className="nav nav-tabs" role="tablist">
            <li className="nav-item">
                <a className="nav-link active" data-bs-toggle="tab" href="#home">Photo Album</a>
            </li>
            <li className="nav-item">
                <a className="nav-link" data-bs-toggle="tab" href="#menu1">Settings</a>
            </li>
        </ul>
        ...
        <div className="tab-content">
            <div id="home" className="container tab-pane active"><br />
                ...
                <div className="db-int-pro-2" style={{ width: "80%" }}>
                   

                    <h4>Get More Responses By Uploading Your Recent Photography On Your Profile.</h4>
                    {getPhotoUploadForm()}
                    <div class="row">
                        ...
                        <h6>Note:</h6>
                        <p>   1 - You can upload recent photography for your profile photography must be less than 2 MB and in jpg, jpeg and png format.</p>
                  <p>  2 - Resolutions are, maximum 900 * 1200 and minimum 300 * 300 then file size is minimum 10Kb</p>
