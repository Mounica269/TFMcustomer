                        ...
                        <Row className="">
                            <Col md={12}>
                                <Row className="d-flex justify-content-center mb-2">
                                    ...
                                    <Col md={5}>
                                        <h6 className="d-flex justify-content-start text-bold"> {paymentDetails?.bankRefNo}</h6>
                                    </Col>
                                </Row>
                                <Row className="d-flex justify-content-center mb-2">
                                    <Col md={4}>
                                        <label className="text-secondary d-flex justify-content-start">Payment Method</label>
                                    </Col>
                                    <Col md={5}>
                                        <h6 className="d-flex justify-content-start text-success text-bold"> {paymentDetails?.paymentMode}</h6>
                                    </Col>
                                </Row>
                                <Row className="d-flex justify-content-center mb-2">
                                    <Col md={4}>
                                    ...
                                    <Col md={5}>
                                        ...
                                        {moment(paymentDetails?.updatedAt).format("YYYY-DD-MM")}</h6>
                                    </Col>
                                </Row>
                                <Row className="d-flex justify-content-center mb-2">
                                    <Col md={4}>
                                    ...
                                    <Col md={5}>
                                        <h6 className="d-flex justify-content-start text-bold text-success">
                                            {getCommonDataVal("paymentStatus", paymentDetails?.status)}</h6>
                                    </Col>
                                </Row>
                                <Row className="d-flex justify-content-center  mb-2">
                                    <Col md={4}>
                                        <label className="text-secondary d-flex justify-content-start">Amount Paid</label>
                                    </Col>
                                    <Col md={5}>
                                        <h6 className="d-flex justify-content-start  text-bold payment_amount"> ₹{paymentDetails?.amount}</h6>
                                    </Col>
                                </Row>
                            </Col>
                        </Row>
